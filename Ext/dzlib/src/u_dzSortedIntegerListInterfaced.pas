unit u_dzSortedIntegerListInterfaced;
...
function TSortedIntegerListInterfaced.KeyOf(const _Item: Integer): Integer;
begin
  Result := _Item;
end;

function TSortedIntegerListInterfaced.Compare(const _Key1, _Key2: Integer): integer;
begin
  Result := _Key1 - _Key2;
end;

procedure TSortedIntegerListInterfaced.FreeItem(_Item: Integer);
begin
