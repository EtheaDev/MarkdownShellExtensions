...
#define MyAppName 'MarkDown Text Editor and Shell Extensions'
...
AppCopyright=Copyright © 2021-2026 Ethea S.r.l.
...
[Tasks]
Name: desktopicon; Description: {cm:CreateDesktopIcon}; GroupDescription: {cm:AdditionalIcons}; Components: Editor
