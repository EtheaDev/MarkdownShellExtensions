...
type
  ...
  private
    fIndentGuides: Boolean; //Ethea: backward compatibility
    fCollapsedLineColor: TColor;
    fFolderBarLinesColor: TColor;
    fIndentGuidesColor: TColor; //Ethea: backward compatibility
  ...
  published
    ...
    property IndentGuidesColor: TColor read fIndentGuidesColor write fIndentGuidesColor; //Ethea: backward compatibility
    property IndentGuides: Boolean read fIndentGuides write fIndentGuides; //Ethea: backward compatibility
