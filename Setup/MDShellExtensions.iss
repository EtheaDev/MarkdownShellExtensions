...
Source: "..\Bin32\sk4d.dll"; DestDir: "{app}"; Flags: ignoreversion 32bit; Components: Editor
...
Source: "..\Bin64\sk4d.dll"; DestDir: "{app}"; Flags: ignoreversion 64bit; Components: Editor
